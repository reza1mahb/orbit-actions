...
contract ExecuteNitroContracts1Point2Point1UpgradeScript is Script {
  function run() public {
    ...
    CelestiaNitroContracts1Point2Point1UpgradeAction upgradeAction = CelestiaNitroContracts1Point2Point1UpgradeAction(
    ...
    bytes memory upgradeCalldata = abi.encodeCall(
      CelestiaNitroContracts1Point2Point1UpgradeAction.perform,
      (rollup, proxyAdmin)
    );
